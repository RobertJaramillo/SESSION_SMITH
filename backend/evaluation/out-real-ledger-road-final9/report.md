...
- **Gold reference:** 244 facts (8 relationships) extracted from the session notes
...
| --- | --- | --- |
| preservation_rate | 0.44 ± 0.00 (n=1) | 0.05 ± 0.00 (n=1) |
| creative_additions | 93.00 ± 0.00 (n=1) | 18.00 ± 0.00 (n=1) |
| contradictions | 1.50 ± 0.00 (n=1) | 0.50 ± 0.00 (n=1) |
| relationship_accuracy | 0.12 ± 0.00 (n=1) | 0.00 ± 0.00 (n=1) |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DOC_A | Baseline (ChatGPT) | 0 | 4.0 | 5.0 | 4.0 | 4.0 | 0.05 | 18.0 | 0.5 | 0.00 |
| DOC_B | Our System | 0 | 5.0 | 4.0 | 4.0 | 4.5 | 0.44 | 93.0 | 1.5 | 0.12 |

## 5. Conclusion

Averaged over the qualitative rubric, our system scored 4.38 vs the baseline's 4.25 (1–5). Qualitative winner: **Our system**.
- preservation_rate: ours 0.44 vs baseline 0.05 → favors our system.
- relationship_accuracy: ours 0.12 vs baseline 0.00 → favors our system.
- contradictions: ours 1.50 vs baseline 0.50 → favors the baseline.
